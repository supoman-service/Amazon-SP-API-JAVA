...
import com.amazon.spapi.model.listings.ItemRelationship;
 ...
 */
@ApiModel(description = "Relationship details for the listing item in the specified marketplace.")
...
public class ItemRelationshipsByMarketplace {
  ...
  **/
  @ApiModelProperty(required = true, value = "Relationships for the listing item.")
