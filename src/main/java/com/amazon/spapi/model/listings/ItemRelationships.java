...
import com.amazon.spapi.model.listings.ItemRelationshipsByMarketplace;
 ...
 */
@ApiModel(description = "Relationships for a listing item, by marketplace (for example, variations).")
