...
import com.amazon.spapi.model.reportsv2.*;
...
public class ReportsV2Api {
    ...
    public ReportsV2Api(ApiClient apiClient) {
     ...
     * @author AmteMa
     * @date 2022/5/16
     * @param  * @param reportDocumentId
     * @return java.lang.String
     */
    public String getReportByDocumentId(String reportDocumentId) throws ApiException,IOException {
    ...
    public static ReportsV2Api amazonAuthorizationGrantReportsApi(AmazonAuthorConfig authorConfigDTO) {

        var authInfo=new AwsAuthInfo(authorConfigDTO);

        ReportsV2Api reportsApi =new ReportsV2Api.Builder()
    ...
    public static class Builder {
        ...
        public ReportsV2Api build() {
            ...
            return new ReportsV2Api(new ApiClient()
