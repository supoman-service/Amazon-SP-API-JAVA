...
public class NotificationsApi {
    ...
    //无授权模式
    public static NotificationsApi amazonAuthorizationApi(AmazonAuthorConfig authorConfigDTO,String noAuth) {
        var authInfo=new AwsAuthInfo(authorConfigDTO,"noAuth");
    ...
    //授权模式
    public static NotificationsApi amazonAuthorizationApi(AmazonAuthorConfig authorConfigDTO) {
