...
public class SolicitationsApi {
     ...
     */
    public static SolicitationsApi amazonAuthorizationGrantReportsApi(AmazonAuthorConfig authorConfigDTO) {

        var authInfo=new AwsAuthInfo(authorConfigDTO);

        SolicitationsApi reportsApi =new SolicitationsApi.Builder()
