...
public class FbaInboundApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getShipmentItemsByShipmentIdCall(String shipmentId, String marketplaceId,String nextToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getShipmentItemsByShipmentIdValidateBeforeCall(String shipmentId, String marketplaceId,String nextToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getShipmentItemsByShipmentIdCall(shipmentId, marketplaceId,nextToken, progressListener, progressRequestListener);
        return call;
    ...
    public GetShipmentItemsResponse getShipmentItemsByShipmentId(String shipmentId, String marketplaceId,String nextToken) throws ApiException {
        ApiResponse<GetShipmentItemsResponse> resp = getShipmentItemsByShipmentIdWithHttpInfo(shipmentId, marketplaceId,nextToken);
        return resp.getData();
    }
    /**
     *
    ...
    public ApiResponse<GetShipmentItemsResponse> getShipmentItemsByShipmentIdWithHttpInfo(String shipmentId, String marketplaceId,String nextToken) throws ApiException {
        com.squareup.okhttp.Call call = getShipmentItemsByShipmentIdValidateBeforeCall(shipmentId, marketplaceId, nextToken,null, null);
        Type localVarReturnType = new TypeToken<GetShipmentItemsResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public static FbaInboundApi amazonAuthorizationApi(AmazonAuthorConfig authorConfigDTO) {
