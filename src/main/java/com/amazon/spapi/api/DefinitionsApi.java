...
public class DefinitionsApi {
    ...
    public static DefinitionsApi amazonAuthorizationApi(AmazonAuthorConfig authorConfigDTO) {
     ...
     */
    public ProductTypeList searchDefinitionsProductTypes(List<String> marketplaceIds, List<String> keywords, String itemName, String locale, String searchLocale) throws ApiException {
     ...
     */
    public ApiResponse<ProductTypeList> searchDefinitionsProductTypesWithHttpInfo(List<String> marketplaceIds, List<String> keywords, String itemName, String locale, String searchLocale) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call searchDefinitionsProductTypesAsync(List<String> marketplaceIds, List<String> keywords, String itemName, String locale, String searchLocale, final ApiCallback<ProductTypeList> callback) throws ApiException {
