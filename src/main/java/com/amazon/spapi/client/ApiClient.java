...
public class ApiClient {
    ...
    */
     ...
     * 请求限速文档参考：MWS http://docs.developer.amazonservices.com/en_US/dev_guide/DG_Throttling.html
     *  SPAPI:https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/usage-plans-rate-limits/Usage-Plans-and-Rate-Limits.md
...
*/
            ...
            //e.printStackTrace();
            throw new ApiException(e,response.code(),e.getResponseBody());
        } catch (Exception e) {
