...
public class FbaOutboundApiTest {
    ...
    private final FbaOutboundApi api = FbaOutboundApi.amazonAuthorizationApi(authorConfig);
    ...
    public void getFeaturesTest() throws ApiException {
        ...
        GetFeaturesResponse response = api.getFeatures(endpointsEnum.getMarketplaceId());
